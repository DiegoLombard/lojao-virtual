...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" id="welcome">
        <div   class=" flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            
            @if (Route::has('login'))
            
                <div id="nav"  class=" fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a id="home" href="{{ url('/home') }}" class="text-sm text-gray-700 underline">Início</a>
                    @else
